package com.uday.about.controller.test;

import com.uday.about.AboutApplication;
...
@SpringBootTest(webEnvironment=SpringBootTest.WebEnvironment.DEFINED_PORT, classes={ AboutApplication.class })
public class AboutControllerTest {
    ...
    public void setUp() throws Exception {
        this.base = new URL("http://localhost:" + port + "/about");
        template = new TestRestTemplate().withBasicAuth("ap", "apapp!");
    }

    @Test
    public void shouldGetAboutMessage() {
        ResponseEntity<String> response = template.getForEntity(base.toString(), String.class);
        assertThat(response.getStatusCode(), equalTo(HttpStatus.OK));
    }

    @Test
    public void getAboutShouldSendResponseHeaders() {
        ResponseEntity<String> response = template.getForEntity(base.toString(), String.class);
        assertThat(response.getStatusCode(), equalTo(HttpStatus.OK));
